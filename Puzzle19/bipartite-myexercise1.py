...
def bipartiteGraphColorFather(graph, starts, coloring, color):
    for start in starts:
        val, coloring = bipartiteGraphColor(graph, start, coloring, color)
        if val == False:
            return False, {}
...
print (bipartiteGraphColorFather(graph, ['B'], {}, 'Sha'))
print (bipartiteGraphColorFather(dgraph, ['A', 'C'], {}, 'Sha'))
